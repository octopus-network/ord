...
CREATE TABLE IF NOT EXISTS public.rs_runes
(
...
(
    ...
    CONSTRAINT rune_balances_rune_id_fkey FOREIGN KEY (rune_id) REFERENCES public.rs_runes (rune_id)
);
...
(
    ...
    CONSTRAINT rune_transactions_rune_id_fkey FOREIGN KEY (rune_id) REFERENCES public.rs_runes (rune_id),
