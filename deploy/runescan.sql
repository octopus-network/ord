...
CREATE INDEX idx_rune_transactions_txid_reorg ON public.rune_transactions(txid) WHERE reorg = FALSE;
...
CREATE INDEX idx_address_rune_balance_rune_id ON public.address_rune_balance(rune_id);
